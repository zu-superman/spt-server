...
import type { IBodyPartHealth, ICurrentMax } from "@spt/models/eft/common/tables/IBotBase";
import type { IBodyPart, IHealthTreatmentRequestData } from "@spt/models/eft/health/IHealthTreatmentRequestData";
